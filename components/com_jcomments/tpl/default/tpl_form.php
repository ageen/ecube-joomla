...
<form id="comments-form" name="comments-form" class="" action="javascript:void(null);">
<?php
...
<div class="form-group">
	...
	<input id="comments-form-name" type="text" class="form-control" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
...
<div class="form-group">
    ...
    <input id="comments-form-homepage" type="text" class="form-control" name="homepage" value="" size="22" tabindex="3" />
</div>
<?php
		}
...
<div class="form-group">
    ...
    <input id="comments-form-title" type="text" class="form-control" name="title" value="" size="22" tabindex="4" />
</div>
<?php
		}
?>
<div class="form-group">
	<textarea id="comments-form-comment" name="comment" class="form-control" rows="8"></textarea>
</div>
<?php
...
<div class="form-group">
		...
		<input class="captcha form-control" id="comments-form-captcha" type="text" name="captcha_refid" value="" size="5" tabindex="6" />
</div>
<?php
			}
		}
