		...
		if($this->load_ecc == true)
		{
			...
			if(($this->params->get('type_calc') OR $this->params->get('recaptcha') OR $this->params->get('question')) AND !empty($match_extension))
			{
				...
				if($this->params->get('type_calc'))
				{
					...
					$add_string .= '<div class="form-group"><div class="control-label col-sm-4 col-xs-12"><label for="'.$this->session->get('spamcheck', null, 'easycalccheck').'">'.JText::_('PLG_ECC_SPAMCHECK');
					...
					$add_string .= '</label></div>';
					$add_string .= '<div class="col-sm-8 col-xs-12"><input type="text" name="'.$this->session->get('spamcheck', null, 'easycalccheck').'" id="'.$this->session->get('spamcheck', null, 'easycalccheck').'" size="3" class="form-control inputbox '.$this->random().' validate-numeric required" value="" required="required" />';
					$add_string .= '</div></div>';
				...
				if($this->params->get('question') AND $this->params->get('question_q') AND $this->params->get('question_a'))
				{
					...
					$add_string .= '<div class="form-group"><div class="control-label col-sm-4 col-xs-12"><label for="'.$this->session->get('question', null, 'easycalccheck').'">'.$this->params->get('question_q').' </label></div><div class="col-sm-8 col-xs-12"><input type="text" name="'.$this->session->get('question', null, 'easycalccheck').'" id="'.$this->session->get('question', null, 'easycalccheck').'" size="'.$size.'" class="form-control inputbox '.$this->random().'" value="" /></div></div>';
				}
