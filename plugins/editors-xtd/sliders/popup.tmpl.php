...
<div class="header">
	<h1 class="page-title">
		<span class="icon-nonumber icon-sliders"></span>
	...
	<div class="container-fluid">
		<div class="btn-toolbar" id="toolbar">
			<div class="btn-wrapper" id="toolbar-apply">
				<button onclick="if(nnSlidersPopup.insertText()){window.parent.SqueezeBox.close();}" class="btn btn-small btn-success">
		...
		<div class="row-fluid">
			...
			<div class="span8">
				...
				<?php for ($i = 1; $i <= $this->params->button_max_count; $i++) : ?>
					...
					$title   = '<span class="slider_' . $i . '_default_icon icon-default hasTooltip"'
						...
						<div class="span8">
							...
							<div class="control-group">
								<div class="controls">
									...
									<div id="slider_<?php echo $i; ?>_content" style="display:none;" class="well well-small">
										<?php echo $content; ?>
									</div>
								</div>
							</div>
