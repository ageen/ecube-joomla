...
<div class="container contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="https://schema.org/Person">
	...
	<?php if ($tparams->get('show_contact_list') && count($this->contacts) > 1) : ?>
		...
		<div class="form-group">
			<label class="control-label col-sm-2"><?php echo JText::_('COM_CONTACT_SELECT_CONTACT'); ?></label>
			<div class="col-sm-3">
