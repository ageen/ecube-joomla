...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<button name="Search" onclick="this.form.submit()" class="hasTooltip btn btn-primary btn-block" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?>"><span class="icon-search"></span><?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?></button>
	...
	<?php if ($this->params->get('search_phrases', 1)) : ?>
		<fieldset class="container phrases">
...
<?php if ($this->total > 0) : ?>
	<div class="container search-form-limit">
		<label for="limit">
